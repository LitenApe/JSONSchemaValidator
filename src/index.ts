...
function validateNumber(value: number, blueprint: NumberDefinition): boolean {
    ...
    if ('multipleOf' in blueprint) {
        const multiple = blueprint.multipleOf;
    ...
    if ('validator' in blueprint) {
        const validator = blueprint.validator;
